...
std::string ToAll(const std::string& input, std::function<char(const char)> transform) 
{
  std::string s;
...
std::string ConvertCase(const std::string& input, Case output_case, Case input_case) 
{
